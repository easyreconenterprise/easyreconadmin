...
const Minimum3 = ({ subcategory }) => {
  console.log(subcategory?.Income?.["Minimum tax expense"]);

  const properties = subcategory?.Income?.["Minimum tax expense"];
